          ...
          <div className={styles.exampleContainer}>
            ...
            >
              <div className={styles.demoContent}>
                <h4 style={{ margin: '0 0 8px 0', color: 'var(--color-main)' }}>Simple Content</h4>
                <p style={{ margin: 0, color: 'var(--color-sec)' }}>
                  This showcase has no header, just the children content and alert light.
                </p>
              </div>
            </DashboardShowCase>
          </div>
              ...
              <div className={styles.demoContent}>
                <div className={styles.metricsGrid}>
                  ...
                  <div className={styles.metricCard}>
                    ...
                    <div className={styles.metricValue}>3.24%</div>
        ...
        <div className={styles.exampleItem}>
          ...
          <div className={styles.exampleContainer}>
            ...
            >
              <div className={styles.demoContent}>
                <p style={{ margin: 0, color: 'var(--color-sec)' }}>
                  Minimal setup with just a title. No icon, no summary, default alert light.
                </p>
              </div>
            </DashboardShowCase>
          </div>
